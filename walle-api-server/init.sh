...
walle-manage service-url-limits add --service-url http://192.168.0.10:5000/v2.0 --cloudify-host 172.25.1.75 --cloudify-port 80 --deployment-limits 100 --tenant=admin
