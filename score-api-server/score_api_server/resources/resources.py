...
def setup_resources(api):
    ...
    api.add_resource(manage.OrgIdLimitsId, '/manage/org_id_limits/<string:id>')
    api.add_resource(manage.KeystoreUrls, '/manage/keystore_urls')
    api.add_resource(manage.KeystoreUrlsId, '/manage/keystore_urls/<string:keystore_url>')
    api.add_resource(manage.KeyStoreUrlLimits, '/manage/keystore_url_limits')
    api.add_resource(manage.KeyStoreUrlLimitsId, '/manage/keystore_url_limits/<string:id>')
    api.add_resource(manage.ApprovedPlugins, '/manage/approved_plugins')
    api.add_resource(manage.ApprovedPluginsFromFile, '/manage/approved_plugins/from_file')
    api.add_resource(manage.ApprovedPluginsId, '/manage/approved_plugins/<string:name>')
